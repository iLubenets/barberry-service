...
class DirectionPngToGif extends DirectionAbstract {
    protected function init($commandString = null) {
        $this->converter = new Plugin\Imagemagick\Converter;
        $this->converter->configure(ContentType::byExtention('gif'), '/home/il/public_html/barberry-service/vendor/barberry/plugin-imagemagick/tmp/');
