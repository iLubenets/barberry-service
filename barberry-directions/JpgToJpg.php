...
class DirectionJpgToJpg extends DirectionAbstract {
    protected function init($commandString = null) {
        $this->converter = new Plugin\Imagemagick\Converter;
        $this->converter->configure(ContentType::byExtention('jpg'), '/home/il/public_html/barberry-service/vendor/barberry/plugin-imagemagick/tmp/');
